...
import 'package:aplikasi_mobile/features/dashboard/data/models/dashboard_model.dart';
...
class ModernStatCard extends StatefulWidget {
  ...
  @override
  State<ModernStatCard> createState() =>
      _ModernStatCardState();
}

class _ModernStatCardState
    extends State<ModernStatCard>
